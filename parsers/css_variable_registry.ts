 ...
 */
export function registerCssVariables(scope: string, vars: Record<string, string>): void {
    if (!scope || !vars) {
        return;
    }
 ...
 */
export function clearCssVariablesForScope(scope: string): void {
 ...
 */
export function clearAllCssVariables(): void {
 ...
 */
export function lookupCssVariable(name: string, scopes?: string[]): string | undefined {
    if (!name) {
        return undefined;
    }
 ...
 */
export function resolveCssVariables(value: string, scopes?: string[]): string {
    ...
    return resolveVarsRecursive(value, scopes, 0, new Set<string>());
}
 ...
 */
export function extractAndRegisterVariables(
    scope: string,
 ...
 */
export function buildScopeChain(id?: string, className?: string, typeName?: string): string[] {
    const chain: string[] = [];
