...
exports.getWidgetPool = getWidgetPool;
exports.destroyWidgetPool = destroyWidgetPool;
exports.isPoolableType = isPoolableType;
const UE = require("ue");
/**
...
class WidgetPool {
    ...
    _cacheMisses = 0;
    constructor(defaultMaxSize = DEFAULT_MAX_POOL_SIZE) {
     ...
     */
    setMaxPoolSize(typeName, maxSize) {
 ...
 */
function isPoolableType(typeName) {
    return POOLABLE_TYPES.has(typeName);
}
//# sourceMappingURL=widget_pool.js.map