...
exports.TileViewConverter = void 0;
const UE = require("ue");
 ...
 */
class TileViewConverter extends umg_converter_1.UMGConverter {
    /* ------------------------------------------------------------------ */
    /*  Internal tracking                                                  */
    /* ------------------------------------------------------------------ */
    childSlots = new Map();
    ...
    /* ================================================================== */
    applyTileDimensions(wrapBox, props) {
        ...
        if (entryWidth !== undefined) {
            const w = typeof entryWidth === 'number'
                ? entryWidth
                : (0, css_length_parser_1.convertLengthUnitToSlateUnit)(String(entryWidth), styles);
            wrapBox.__tileWidth = w;
            updated = true;
        }
        if (entryHeight !== undefined) {
            const h = typeof entryHeight === 'number'
                ? entryHeight
                : (0, css_length_parser_1.convertLengthUnitToSlateUnit)(String(entryHeight), styles);
            wrapBox.__tileHeight = h;
            updated = true;
        }
        return updated;
    }
    ...
    applySpacing(wrapBox, props) {
        ...
        if (columnGap !== undefined && columnGap !== null) {
            gapX = typeof columnGap === 'number'
                ? columnGap
                : (0, css_length_parser_1.convertLengthUnitToSlateUnit)(String(columnGap), styles);
        }
        const rowGap = styles?.rowGap ?? props?.rowGap ?? props?.verticalSpacing;
        if (rowGap !== undefined && rowGap !== null) {
            gapY = typeof rowGap === 'number'
                ? rowGap
                : (0, css_length_parser_1.convertLengthUnitToSlateUnit)(String(rowGap), styles);
        }
        if (gapX > 0 || gapY > 0) {
    ...
    /* ================================================================== */
    applyOrientation(wrapBox, props) {
    ...
    createNativeWidget() {
        ...
        if (scrollable) {
            ...
            if (typeof this.props?.showScrollbar === 'boolean') {
                this.scrollBoxWrapper.SetScrollBarVisibility(this.props.showScrollbar
                    ? UE.ESlateVisibility.Visible
                    : UE.ESlateVisibility.Collapsed);
            }
            if (propsApplied) {
                (0, batch_sync_1.queueWidgetSync)(this.wrapBox);
            }
            (0, batch_sync_1.queueWidgetSync)(this.scrollBoxWrapper);
    ...
    update(widget, _oldProps, changedProps) {
        ...
        const targetWrapBox = this.wrapBox ?? widget;
        const propsChanged = this.initProps(targetWrapBox, changedProps);
        if (propsChanged) {
            (0, batch_sync_1.queueWidgetSync)(targetWrapBox);
        }
    }
    /* ================================================================== */
    ...
    appendChild(parent, child, childTypeName, childProps) {
        ...
        const tileWidth = targetWrapBox.__tileWidth;
        const tileHeight = targetWrapBox.__tileHeight;
...
exports.TileViewConverter = TileViewConverter;
